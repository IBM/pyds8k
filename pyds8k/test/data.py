    ...
    "responses": [
        {
            ...
            "data": {"volumes": [{"name": "lou_test1", "id": "0010"}]},
            "link": {
                "rel": "self",
        ...
        },
        {
            ...
            "data": {"volumes": [{"name": "lou_test2", "id": "0011"}]},
            "link": {
                "rel": "self",
...
create_lss_response = {
    "server": {"status": "ok", "code": "", "message": ""},
    "data": {
        "lss": [
            {
                "id": "FE",
                "link": {"rel": "self", "href": "http://rest_url/v1/lss/FE"},
                "group": "0",
                "addrgrp": "",
                "type": "ckd",
                ...
                "configvols": "0",
                "volumes": {
                    "link": {"rel": "self", "href": "http://rest_url/v1/lss/FE/volumes"}
                },
            }
        ]
    },
    "link": {"rel": "self", "href": "http://localhost:8080/ds8000-rest-api/v1/lss/FE"},
}
...
create_volume_response = {
    "server": {"status": "ok", "code": "", "message": "Operation done successfully."},
    "data": {"volumes": [{"name": "lou_test1", "id": "0010"}]},
    "link": {"rel": "self", "href": "https://localhost:8088/api/v1/volumes/0010"},
}
...
create_host_response = {
    "server": {"status": "ok", "code": "", "message": "Operation done successfully."},
    "link": {"rel": "self", "href": "https://localhost:8088/api/v1/hosts/host1"},
}
...
create_resource_group_response_json = json.dumps(create_resource_group_response)
...
create_hmc_certificate_csr_response_json = json.dumps(
    create_hmc_certificate_csr_response
)
