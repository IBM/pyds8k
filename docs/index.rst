...
Overview
--------
**pyds8k** is a Python package containing classes that can talk to several
...
**pyds8k** distribution. To generate the docs locally run the
following command from the root directory of the **pyds8k** source.
